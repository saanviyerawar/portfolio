...
function WorkExperience() {
  ...
  const workExperienceList = [
    ...
    { colour: `${mode === "dark" ? "#D37B44" : "#97D7FF"}`, textColour: `${mode === "dark" ? "#FFFFFF" : "#000000"}`, rotate: "5deg", top: { default: "200px", sm: "300px", md: "400px", lg: "500px" }, information: { title: "Digital A.I. Engineer", company: "Optus",  image: "Optus", description: ["Drove innovation in an agile environment through the creation of analytical business intelligent assets and dashboards to help efficiency and effectiveness of data-driven business decision", "Developed an application to automate dashboard creation processes, reducing processes from a week to a few hours", "Managed multiple stakeholders and prioritised value creation generated by actionable-level and analytical insights"]}},
    { colour: `${mode === "dark" ? "#B25754" : "#98CB3D"}`, textColour: `${mode === "dark" ? "#FFFFFF" : "#000000"}`, rotate: "-6deg", top: { default: "220px", sm: "340px", md: "420px", lg: "600px" }, information: { title: "Co-Founder", company: "Nagaraj Music",  image: "Nagaraj-Music", description: ["Nagaraj Music aims to adapt famous Bollywood music into Western musical notation", "Continuously improving to satisfy customer experience and relationships", "Started from a YouTube comment, and now sells in over 23 countries", "Utilised user research, design thinking and problem solving to develop and scale Nagaraj Music"]}},
  ];
