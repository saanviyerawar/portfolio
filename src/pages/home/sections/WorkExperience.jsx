...
function WorkExperience() {
  ...
  const workExperienceList = [
    { colour: `${mode === "dark" ? "#9F3B47" : "#97D7FF"}`, textColour: `${mode === "dark" ? "#FFFFFF" : "#000000"}`, rotate: "5deg", top: { default: "40px", sm: "60px", md: "80px", lg: "100px" },  information: { title: "Growth & Operations Associate", company: "Build Club", image: "BuildClub", description: [""]}},
    ...
    { colour: `${mode === "dark" ? "#B25754" : "#97D7FF"}`, textColour: `${mode === "dark" ? "#FFFFFF" : "#000000"}`, rotate: "5deg", top: { default: "120px", sm: "180px", md: "240px", lg: "300px" },  information: { title: "Data & Digital Transformation", company: "PwC", image: "PwC", description: [""] }},
    ...
    { colour: `${mode === "dark" ? "#B25754" : "#97D7FF"}`, textColour: `${mode === "dark" ? "#FFFFFF" : "#000000"}`, rotate: "5deg", top: { default: "200px", sm: "300px", md: "400px", lg: "500px" },  information: { title: "Data Science Ambassador", company: "UNSW",  image: "UNSW", description: [""]}}
  ];
