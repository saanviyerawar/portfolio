...
function Projects () {
  ...
  const projectList = [
    {title: "Flizzle", image: "Flizzle", shadow: true, skills: ["Python","Machine Learning","Product", "Figma"], description: ["Nagaraj Music aims to adapt famous Bollywood music into Western musical notation", "Leveraged design thinking to create a product that sells in over 23 countries"]},
