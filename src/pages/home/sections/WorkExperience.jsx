...
function WorkExperience() {
  ...
  const workExperienceList = [
    ...
    { colour: `${mode === "dark" ? "#9F3B47" : "#98CB3D"}`, textColour: `${mode === "dark" ? "#FFFFFF" : "#000000"}`, rotate: "5deg", top: { default: "160px", sm: "240px", md: "320px", lg: "400px" }, information: { title: "Data Science & Decisions Ambassador", company: "UNSW",  image: "UNSW", description: [""]}}
  ];
