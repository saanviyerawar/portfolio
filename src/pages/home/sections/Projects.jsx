...
function Projects () {
  ...
  const projectList = [
    {title: "Nagaraj Music", image: "Nagaraj-Music", skills: ["Product", "Figma"], description: ["Nagaraj Music aims to adapt famous Bollywood music into Western musical notation", "Leveraged design thinking to create a product that sells in over 23 countries"]},
    {title: "Interconnect", image: "Interconnect", skills: ["Product", "Figma"], description: ["Interconnect aims to break down social exclusivity barriers to connect non-English background international students into the wider student community", "Lead the winning team as a Product Manager", "Aims to solve the social disconnection of international students after COVID-19 lockdowns"]},
    {title: "Trust-o-Meter", image: "Trust-o-Meter", skills: ["Product", "Figma", "Javascript", "React", "HTML", "CSS"], description: ["Trust-o-meter is a website that determines the quality of the information provided on a link or content of a website", "Aims to solve the spread of disinformation across the digital platform", "Developed the full stack website using Javascript, React, HTML, CSS and AI"]},
    {title: "Outings", image: "Outings", skills: ["Product", "Figma", "Javascript", "React", "HTML", "CSS", "Python"], description: ["Outings aims to streamline details and logistics of outings with your friends", "Concept part of Blackbird Giants Founder (Cohort 6)", "Developed an MVP using Javascript and React"]},
    {title: "BSOCBear", image: "BSOCBear", skills: ["Python", "Product"], description: ["BSOCBear aims to connect like-minded students by building an online community, whilst being an internal automation tool", "Developed a Discord bot for UNSW's largest society", "Used Python and Discord API to develop a discord bot to engage with 13,000+ students"]},
    {title: "ProJector", image: "ProJector", skills: ["Python", "Javascript", "React", "HTML", "CSS", "Product", "Figma"], description: ["Projector aims to bridge the gap between companies and professionals, to streamline pairing of professional project-based work", "Achieved HD on UNSW capstone subject", "Lead a team of 5 as the team leader to develop a website"]},
  ];
