...
function Projects () {
  ...
  const projectList = [
    {title: "Flizzle", image: "Flizzle", shadow: true, skills: ["Python", "Product", "React", "Javascript", "Figma"], description: ["Co-founded Flizzle, an AI-powered Quizlet-style platform providing personalized, adaptive learning experiences for neurodivergent children", "Developed an MVP using Python, React, JavaScript, and AI/ML techniques", "Concept was part of UNSW's New Wave Founder Cohort (top 10 pitches)"] },
